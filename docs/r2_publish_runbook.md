...
| 公開 base URL | `https://pub-xxxxxxxxxxxxxxxx.r2.dev` | 初期は R2 標準 URL |
...
```bash
--public-base-url https://pub-xxxxxxxxxxxxxxxx.r2.dev
```

この場合、生成される URL は以下になる。

```text
https://pub-xxxxxxxxxxxxxxxx.r2.dev/videos/{publicId}.mp4
https://pub-xxxxxxxxxxxxxxxx.r2.dev/thumbnails/{publicId}.webp
```
...
5. 代表 URL をブラウザまたは `curl` で確認する。
   ...
   ```bash
   curl -I https://pub-xxxxxxxxxxxxxxxx.r2.dev/videos/{publicId}.mp4
   curl -I https://pub-xxxxxxxxxxxxxxxx.r2.dev/thumbnails/{publicId}.webp
   ```
