...
個別動画のURLをDiscordなどに貼ると、対応サービスでサムネイルと説明文をプレビューできます。サービス内での動画再生に対応するかは共有先によって異なります。表示されない場合はURLを開いて再生してください。公開後の確認方法は [共有プレビュー](docs/share_previews.md) を参照してください。
